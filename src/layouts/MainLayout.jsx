...
export default function MainLayout() {
    ...
    return (
        <div className="flex h-screen bg-background text-foreground overflow-hidden">
            ...
            <aside
                className={cn(
                    "fixed inset-y-0 left-0 z-50 w-64 transform border-r bg-card/80 backdrop-blur-xl transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 flex flex-col shadow-xl lg:shadow-none",
